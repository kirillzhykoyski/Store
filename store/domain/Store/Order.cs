...
namespace Store
{
    public class Order
    {
        ...
        public string CellPhone
        {
            ...
            set
            {
                // Если у заказа нет информации о доставке, возвращаем null.
        ...
        public OrderDelivery Delivery
        {
            get
            {
                ...
                // Устанавливаем информацию о доставке в заказ.
            ...
            set
            {
                // Если у заказа нет информации о платеже, возвращаем null.
                if (value == null)
                    throw new ArgumentException(nameof(Delivery));

                // Устанавливаем информацию о платеже в заказ.
