...
namespace Store.Contractors
{
    public class Form
    {
        public string ServiceName { get; }  // Название сервиса формы

        public int Step { get; }  // Шаг формы

        public bool IsFinal { get; }  // Флаг, указывающий, является ли форма финальной

        private readonly Dictionary<string, string> parameters;  // Словарь параметров формы
        public IReadOnlyDictionary<string, string> Parameters => parameters;

        private readonly List<Field> fields;  // Список полей формы
