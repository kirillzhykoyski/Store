...
namespace Store.Web.Controllers
{
    public class OrderController : Controller
    {
        ...
        [HttpGet]
        // Действие, которое будет обрабатывать GET-запрос на URL /Order/Index
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/AddItem
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/UpdateItem
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/RemoveItem
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/SendConfirmation
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/ConfirmCellPhone
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/StartDelivery
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/NextDelivery
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/StartPayment
        ...
        [HttpPost]
        // Действие, которое будет обрабатывать POST-запрос на URL /Order/NextPayment
